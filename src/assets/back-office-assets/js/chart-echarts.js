    ...
    CRYPTOKIT_SETTINGS.dashboardEcharts=function() {
        ...
        if($("#user_type").length) {
            ...
            var option= {
                ...
                calculable: true, // Horizontal axis
                xAxis: [ {
                    type: 'category', boundaryGap: false, data: ['2023-06-01', '2023-05-01', '2023-04-01', '2023-03-01', '2023-02-01'], axisLine: {
                        show: true, onZero: true, lineStyle: {
                            color: '#e77512', type: 'solid', width: '2', shadowColor: 'rgba(0,0,0,0)', shadowBlur: 5, shadowOffsetX: 3, shadowOffsetY: 3,
                        }
                        ,
        ...
        if($("#scatter_chart").length) {
            ...
            var option= {
                ...
                , xAxis: [ {
                    ...
                    name:'2023', type:'scatter', data: [[161, 51], [167, 59], [159, 49], [157, 63], [155, 53], [170, 59], [159, 47], [166, 69], [176, 66], [160, 75], [172, 55], [170, 54], [172, 62], [153, 42], [160, 50], [147, 49], [168, 49], [175, 73], [157, 47], [167, 68]], markPoint: {
                        show:false, data: [ {
                            type: 'max', name: ''
                        }
                        , {
        ...
        if($("#user_type_bar").length) {
            ...
            var option= {
                ...
                calculable: true, // Horizontal axis
                xAxis: [ {
                    type: 'category', boundaryGap: false, data: ['2023-06-01', '2023-05-01', '2023-04-01', '2023-03-01', '2023-02-01', '2023-01-01', '2015-12-01', '2015-11-01', '2015-10-01', '2015-09-01'], axisLine: {
                        show: true, onZero: true, lineStyle: {
                            color: '#e77512', type: 'solid', width: '2', shadowColor: 'rgba(0,0,0,0)', shadowBlur: 5, shadowOffsetX: 3, shadowOffsetY: 3,
                        }
                        ,
