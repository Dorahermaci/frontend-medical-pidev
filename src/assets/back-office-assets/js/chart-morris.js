    ...
    CRYPTOKIT_SETTINGS.chartMorris=function() {
        ...
        if($("#morris_bar_graph").length) {
            ...
            Morris.Bar( {
                ...
                , {
                    x: '2023 Q3', y: 0, z: 2, a: 4
                }
                , {
                    x: '2023 Q4', y: 2, z: 4, a: 3
                }
        ...
        if($("#morris_line_graph").length) {
            ...
            var day_data=[ {
                "period": "2023-10-01", "licensed": 5000, "sorned": 2660
            }
            , {
                "period": "2023-09-30", "licensed": 3784, "sorned": 1655
            }
            , {
                "period": "2023-09-29", "licensed": 2536, "sorned": 1732
            }
            , {
                "period": "2023-09-20", "licensed": 4782, "sorned": 2661
            }
            , {
                "period": "2023-09-19", "licensed": 2212, "sorned": 1230
            }
            , {
                "period": "2023-09-18", "licensed": 4898, "sorned": 2738
            }
            , {
                "period": "2023-09-17", "licensed": 3171, "sorned": 1238
            }
            , {
                "period": "2023-09-16", "licensed": 3171, "sorned": 2676
            }
            , {
                "period": "2023-09-15", "licensed": 3974, "sorned": 989
            }
            , {
                "period": "2023-09-10", "licensed": 4676, "sorned": 3100
            }
            ];
            Morris.Line( {
        ...
        if($("#morris_negative_graph").length) {
            /*Negative Line Graph*/
            var neg_data=[ {
                "period": "2023-08-12", "a": 100
            }
            , {
                "period": "2023-03-03", "a": 75
            }
            , {
        ...
        if($("#morris_nogrid_graph").length) {
            ...
            /* data stolen from http://howmanyleft.co.uk/vehicle/jaguar_'e'_type */
            var day_data=[ {
                "period": "2023-10-01", "licensed": 3407, "sorned": 660
            }
            , {
                "period": "2023-09-30", "licensed": 3351, "sorned": 629
            }
            , {
                "period": "2023-09-29", "licensed": 3269, "sorned": 618
            }
            , {
                "period": "2023-09-20", "licensed": 3246, "sorned": 661
            }
            , {
                "period": "2023-09-19", "licensed": 3257, "sorned": 667
            }
            , {
                "period": "2023-09-18", "licensed": 3248, "sorned": 627
            }
            , {
                "period": "2023-09-17", "licensed": 3171, "sorned": 660
            }
            , {
                "period": "2023-09-16", "licensed": 3171, "sorned": 676
            }
            , {
                "period": "2023-09-15", "licensed": 3201, "sorned": 656
            }
            , {
                "period": "2023-09-10", "licensed": 3215, "sorned": 622
            }
            ];
            Morris.Line( {
        ...
        if($("#morris_noncontinuous_graph").length) {
            ...
            /* data stolen from http://howmanyleft.co.uk/vehicle/jaguar_'e'_type */
            var day_data=[ {
                "period": "2023-10-01", "licensed": 3407
            }
            , {
                "period": "2023-09-30", "sorned": 0
            }
            , {
                "period": "2023-09-29", "sorned": 618
            }
            , {
                "period": "2023-09-20", "licensed": 3246, "sorned": 661
            }
            , {
                "period": "2023-09-19", "licensed": 3257, "sorned": null
            }
            , {
                "period": "2023-09-18", "licensed": 3248, "other": 1000
            }
            , {
                "period": "2023-09-17", "sorned": 0
            }
            , {
                "period": "2023-09-16", "sorned": 0
            }
            , {
                "period": "2023-09-15", "licensed": 3201, "sorned": 656
            }
            , {
                "period": "2023-09-10", "licensed": 3215
            }
            ];
            Morris.Line( {
