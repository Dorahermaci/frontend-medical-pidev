...
export class MedicalFolderService {
  ...
  updateMedicalFolder(id: number, medicalFolder: MedicalFolder): Observable<MedicalFolder> {
    return this.http.put<MedicalFolder>(`${this.baseUrl}/medical-folders/${id}`, medicalFolder);
  }
